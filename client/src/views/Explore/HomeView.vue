<template>
    <div class="flex flex-no-wrap bg-gray-200">
        <!-- Sidebar starts -->
        <div class="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div>
        ...
        <div class="w-64 z-40 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
            id="mobile-nav">
            <div id="openSideBar"
                class="h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
            ...
            <div id="closeSideBar"
                class="hidden h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
        ...
        <div class="w-full">
            ...
            <nav
                ...
                <div class="lg:flex w-full">
                    <div class="w-1/2 h-full lg:flex items-center pl-6 pr-2">
                                        ...
                                        <li
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-sm ml-2">
                                                    <router-link to="/explore/profile">Profile</router-link>
                                                </span>
                                            </div>
                                        </li>
                ...
                <div class="text-gray-600 mr-8 visible lg:hidden relative" @click="dropdownHandler($event)">
                    <ul class="p-2 w-40 border-r bg-white absolute rounded right-0 shadow mt-12 hidden">
                        ...
                        <li
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bell" width="18"
                                    height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                    <path
                                ...
                                <span class="text-sm ml-2">Notification</span>
                            </div>
                        </li>
                        <li
                            class="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
            ...
            <div class="container mx-auto md:w-4/5 w-11/12">
                <div class="">
                    ...
                    <div class="">
                        <!-- <div
                            v-for="(booksInDept, department) in booksByDepartment"
                            :key="department"
                            >
                            <h2 class="text-2xl font-semibold mt-8">{{ department }}</h2>
                            <div class="flex flex-wrap">
                                <div
                                    v-for="book in booksInDept"
                                    :key="book.id"
...
export default {
    ...
    //             if (!acc[book.department]) {
    //                 acc[book.department] = [];
    //             }
    //             acc[book.department].push(book);
    //             return acc;
    //         }, {});
    //     }
    // },
